(function ($) {
    ...
    function fnPjax(selector, container, options) {
        ...
        return this.on('click.pjax', selector, function (event) {
            ...
            if (!opts.container)if (dataPjax === '') opts.container = '#admui-pageContent'; else opts.container = $(this).attr('data-pjax') || context;
    ...
    function optionsFor(container, options) {
        if (container && options) options.container = container; else if ($.isPlainObject(container)) options = container; else options = {container: container};
